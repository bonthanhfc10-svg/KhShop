...
export default function MobileSidebar({ open, onClose, onLogout, loggingOut = false, role }) {
  return (
    <>
      {open && (
        <div
      ...
      >
        ...
        <AdminSidebarContent onNavigate={onClose} onLogout={onLogout} loggingOut={loggingOut} role={role} />
      </aside>
    </>
  );
}
